...
class EmpleadosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create empleado" do
    assert_difference('Empleado.count') do
      post empleados_url, params: { empleado: { apellidos: @empleado.apellidos, ci: @empleado.ci, nombre: @empleado.nombre, numeroCuenta: @empleado.numeroCuenta, profesion: @empleado.profesion, telefono: @empleado.telefono } }
    end
  ...
  test "should update empleado" do
    patch empleado_url(@empleado), params: { empleado: { apellidos: @empleado.apellidos, ci: @empleado.ci, nombre: @empleado.nombre, numeroCuenta: @empleado.numeroCuenta, profesion: @empleado.profesion, telefono: @empleado.telefono } }
